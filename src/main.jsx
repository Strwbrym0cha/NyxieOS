...
function App(){const [screen,setScreen]=useState('home'),[data,setData,cloud]=useStore();const page=screen==='home'?<HomeCommand {...{data,setData,setScreen}}/>:screen==='plan'?<TaskCrud {...{data,setData}}/>:screen==='money'?<MoneyCrud {...{data,setData}}/>:screen==='cosplay'?<CosplayCrud {...{data,setData}}/>:screen==='conventions'?<ConventionCrud {...{data,setData}}/>:screen==='travel'?<TravelCrud {...{data,setData}}/>:screen==='creator'?<CreatorHQ {...{data,setData}}/>:screen==='wellness'?<WellnessCrud {...{data,setData}}/>:screen==='routines'?<RoutineCrud {...{data,setData}}/>:screen==='yuu'?<YuuChat {...{data,setData,setScreen}}/>:screen==='settings'?<Settings {...{data,setData,cloud}}/>:<MoreFixed setScreen={setScreen}/>;return <AppShell {...{screen,setScreen}}>{page}</AppShell>}
